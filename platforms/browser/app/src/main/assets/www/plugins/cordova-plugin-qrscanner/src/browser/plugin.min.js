...
module.exports = function(){
  ...
  function getVideoPreview(){
    return window.shadowRoot.getElementById(ELEMENTS.preview);
  }

  function getImg(){
    return window.shadowRoot.getElementById(ELEMENTS.still);
  }
  ...
  function initialize(success, error){
    ...
    if(!getVideoPreview()){
      ...
      stillImg.setAttribute('style', 'display:block;visibility: hidden;' +
      'width:100%;height:100%;z-index:' + ZINDEXES.still +
      ';' +
      'background-size:cover;background-position:50% 50%;background-color:#FFF;');

		var items = window.shadowRoot.querySelectorAll(".root");
 		var lastchild = items[items.length-1];
      lastchild.querySelector("#qrcode_scanner").appendChild(videoPreview);
      lastchild.querySelector("#qrcode_scanner").appendChild(stillImg);
    }
    if(backCamera === null){
