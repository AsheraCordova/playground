...
export const enum ThumbTintMode {
add = "add",
multiply = "multiply",
screen = "screen",
src_atop = "src_atop",
...
export const enum TrackTintMode {
add = "add",
multiply = "multiply",
screen = "screen",
src_atop = "src_atop",
...
export abstract class SwitchImpl<T> extends ViewImpl<T>{
	...
	@Type(() => CommandAttr)
	@Expose({ name: "showText" })
	showText!:CommandAttr<boolean>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "splitTrack" })
	splitTrack!:CommandAttr<boolean>| undefined;
	@Type(() => CommandAttr)
	...
	@Type(() => CommandAttr)
	@Expose({ name: "thumb" })
	thumb!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "thumbTextPadding" })
	thumbTextPadding!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "thumbTint" })
	thumbTint!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "thumbTintMode" })
	thumbTintMode!:CommandAttr<ThumbTintMode>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "track" })
	track!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "trackTint" })
	trackTint!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "trackTintMode" })
	trackTintMode!:CommandAttr<TrackTintMode>| undefined;
	@Type(() => CommandAttr)
	...
	@Type(() => CommandAttr)
	@Expose({ name: "switchTextAppearance" })
	switchTextAppearance!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "text" })
...
this.gravity.setTransformer('gravity');		return this.thisPointer;
	...
	public tryGetShowText() : T {
		this.resetIfRequired();
		if (this.showText == null || this.showText == undefined) {
			this.showText = new CommandAttr<boolean>()
		}
		
		this.showText.setGetter(true);
		this.orderGet++;
		this.showText.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	...
	public isShowText() : boolean {
		...
		return this.showText.getCommandReturnValue();
	}
	public setShowText(value : boolean) : T {
		this.resetIfRequired();
		if (this.showText == null || this.showText == undefined) {
			this.showText = new CommandAttr<boolean>();
		}
		
		this.showText.setSetter(true);
		this.showText.setValue(value);
		this.orderSet++;
		this.showText.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetSplitTrack() : T {
		this.resetIfRequired();
		if (this.splitTrack == null || this.splitTrack == undefined) {
			this.splitTrack = new CommandAttr<boolean>()
		}
		
		this.splitTrack.setGetter(true);
		this.orderGet++;
		this.splitTrack.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public isSplitTrack() : boolean {
		if (this.splitTrack == null || this.splitTrack == undefined) {
			this.splitTrack = new CommandAttr<boolean>();
		}
		return this.splitTrack.getCommandReturnValue();
	}
	public setSplitTrack(value : boolean) : T {
		this.resetIfRequired();
		if (this.splitTrack == null || this.splitTrack == undefined) {
			this.splitTrack = new CommandAttr<boolean>();
		}
		
		this.splitTrack.setSetter(true);
		this.splitTrack.setValue(value);
		this.orderSet++;
		this.splitTrack.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public tryGetThumb() : T {
		this.resetIfRequired();
		if (this.thumb == null || this.thumb == undefined) {
			this.thumb = new CommandAttr<string>()
		}
		
		this.thumb.setGetter(true);
		this.orderGet++;
		this.thumb.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	...
	public getThumb() : string {
		...
		return this.thumb.getCommandReturnValue();
	}
	public setThumb(value : string) : T {
		this.resetIfRequired();
		if (this.thumb == null || this.thumb == undefined) {
			this.thumb = new CommandAttr<string>();
		}
		
		this.thumb.setSetter(true);
		this.thumb.setValue(value);
		this.orderSet++;
		this.thumb.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetThumbTextPadding() : T {
		this.resetIfRequired();
		if (this.thumbTextPadding == null || this.thumbTextPadding == undefined) {
			this.thumbTextPadding = new CommandAttr<string>()
		}
		
		this.thumbTextPadding.setGetter(true);
		this.orderGet++;
		this.thumbTextPadding.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getThumbTextPadding() : string {
		if (this.thumbTextPadding == null || this.thumbTextPadding == undefined) {
			this.thumbTextPadding = new CommandAttr<string>();
		}
		return this.thumbTextPadding.getCommandReturnValue();
	}
	public setThumbTextPadding(value : string) : T {
		this.resetIfRequired();
		if (this.thumbTextPadding == null || this.thumbTextPadding == undefined) {
			this.thumbTextPadding = new CommandAttr<string>();
		}
		
		this.thumbTextPadding.setSetter(true);
		this.thumbTextPadding.setValue(value);
		this.orderSet++;
		this.thumbTextPadding.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public tryGetThumbTintMode() : T {
		this.resetIfRequired();
		if (this.thumbTintMode == null || this.thumbTintMode == undefined) {
			this.thumbTintMode = new CommandAttr<ThumbTintMode>()
		}
		
		this.thumbTintMode.setGetter(true);
		this.orderGet++;
		this.thumbTintMode.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getThumbTintMode() : ThumbTintMode {
		if (this.thumbTintMode == null || this.thumbTintMode == undefined) {
			this.thumbTintMode = new CommandAttr<ThumbTintMode>();
		}
		return this.thumbTintMode.getCommandReturnValue();
	}
	public setThumbTintMode(value : ThumbTintMode) : T {
		this.resetIfRequired();
		if (this.thumbTintMode == null || this.thumbTintMode == undefined) {
			this.thumbTintMode = new CommandAttr<ThumbTintMode>();
		}
		
		this.thumbTintMode.setSetter(true);
		this.thumbTintMode.setValue(value);
		this.orderSet++;
		this.thumbTintMode.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetTrack() : T {
		this.resetIfRequired();
		if (this.track == null || this.track == undefined) {
			this.track = new CommandAttr<string>()
		}
		
		this.track.setGetter(true);
		this.orderGet++;
		this.track.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	...
	public getTrack() : string {
		...
		return this.track.getCommandReturnValue();
	}
	public setTrack(value : string) : T {
		this.resetIfRequired();
		if (this.track == null || this.track == undefined) {
			this.track = new CommandAttr<string>();
		}
		
		this.track.setSetter(true);
		this.track.setValue(value);
		this.orderSet++;
		this.track.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public tryGetTrackTintMode() : T {
		this.resetIfRequired();
		if (this.trackTintMode == null || this.trackTintMode == undefined) {
			this.trackTintMode = new CommandAttr<TrackTintMode>()
		}
		
		this.trackTintMode.setGetter(true);
		this.orderGet++;
		this.trackTintMode.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getTrackTintMode() : TrackTintMode {
		if (this.trackTintMode == null || this.trackTintMode == undefined) {
			this.trackTintMode = new CommandAttr<TrackTintMode>();
		}
		return this.trackTintMode.getCommandReturnValue();
	}
	public setTrackTintMode(value : TrackTintMode) : T {
		this.resetIfRequired();
		if (this.trackTintMode == null || this.trackTintMode == undefined) {
			this.trackTintMode = new CommandAttr<TrackTintMode>();
		}
		
		this.trackTintMode.setSetter(true);
		this.trackTintMode.setValue(value);
		this.orderSet++;
		this.trackTintMode.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setSwitchTextAppearance(value : string) : T {
		this.resetIfRequired();
		if (this.switchTextAppearance == null || this.switchTextAppearance == undefined) {
			this.switchTextAppearance = new CommandAttr<string>();
		}
		
		this.switchTextAppearance.setSetter(true);
		this.switchTextAppearance.setValue(value);
		this.orderSet++;
		this.switchTextAppearance.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
