...
export abstract class RelativeLayoutImpl<T>  extends ViewGroupImpl<T>{
	//start - body
	static initialize() {
...
export class RelativeLayout_LayoutParams extends RelativeLayoutImpl_LayoutParams<RelativeLayout_LayoutParams> implements ILayoutParam {
    getThisPointer(): RelativeLayout_LayoutParams {
        return this;
    }
...
export class RelativeLayout extends RelativeLayoutImpl<RelativeLayout> implements IWidget{
    getThisPointer(): RelativeLayout {
        return this;
    }
