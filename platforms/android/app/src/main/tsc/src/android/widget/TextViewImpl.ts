...
export abstract class TextViewImpl<T> extends ViewImpl<T> {
	...
	@Type(() => CommandAttr)
	@Expose({ name: "autoSizePresetSizes" })
...
export class TextView extends TextViewImpl<TextView> implements IWidget{
    getThisPointer(): TextView {
        return this;
    }
