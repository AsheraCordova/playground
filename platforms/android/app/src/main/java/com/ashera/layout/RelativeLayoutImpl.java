...
Context context = (Context) fragment.getRootActivity();
	...
	if (systemStyle == null && systemAndroidAttrStyle == null) {
		relativeLayout = new RelativeLayoutExt(context);
	} else {
		int defStyleAttr = 0;
		int defStyleRes = 0;
		...
		if (defStyleRes == 0) {
			relativeLayout = new RelativeLayoutExt(context, null, defStyleAttr);	
		} else {
			relativeLayout = new RelativeLayoutExt(context, null, defStyleAttr, defStyleRes);
		}
...
return layoutParams.alignWithParent;			}
	...
	public class RelativeLayoutExt extends android.widget.RelativeLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		...
		public RelativeLayoutExt(Context context, android.util.AttributeSet attrs, int defStyleAttr) {
	        super(context, attrs, defStyleAttr);
	    }

	    public RelativeLayoutExt(Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
